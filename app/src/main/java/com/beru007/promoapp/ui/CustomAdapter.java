package com.beru007.promoapp.ui;
...
import com.beru007.promoapp.TransactionObject;
        ...
        if (convertView == null) {
            ...
            switch (rowType) {
                case TYPE_ITEM:
                    ...
                    holder.textView = (TextView) convertView.findViewById(R.id.pid);
                    holder.txtValue = (TextView) convertView.findViewById(R.id.name);
